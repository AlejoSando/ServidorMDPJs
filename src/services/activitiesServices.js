...
async function getOneActivityById(id){
    try{
...
async function createActivity(titulo, descripcion, id, idSubCategoria, idDatos) {
    try{
...
async function updateActivity(titulo, descripcion, id, idSubCategoria, idDatos) {
    try {
